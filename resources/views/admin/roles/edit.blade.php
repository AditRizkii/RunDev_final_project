                ...
                <div class="d-flex flex-column">
                    <form method="POST" action="{{ route('admin.roles.update', $role) }}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="name" class="form-control" id="name" placeholder="editor" value="{{ $role->name }}">
                          ...
                          <div class="d-flex justify-content-center">
                            <a href="{{ route('admin.roles.index') }}" class="px-4 mx-4 py-2 mb-2 badge rounded-pill bg-secondary">Back to Roles Page</a>
