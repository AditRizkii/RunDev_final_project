<div class="modal fade" id="kunkerModal{{ $post->id }}" tabindex="-1" aria-labelledby="exModalLabel" aria-hidden="true">
        ...
        <div class="modal-content rounded-25">
            <div class="modal-body py-0 px-0">
                <div class="row">
                    <div class="col">
                        <img id="post"
                            style="width: 100%; height: 100%; border-top-left-radius: 10px;
                    ...
                    <div class="col mx-5 my-3 margin-left-5 text-dark">
                        ...
                        <div class="p-3 flex">
                            <img src="{{ Vite::asset('public/assets/img/post/likea.png') }}" id="like"
                                style="width: 35px" alt="" onclick="changeImage(this)">
                        </div>
                    </div>
                </div>
            </div>
