<header class="bg-gradient-dark">
    <div class="page-header min-vh-85" style="background-image: url('../assets/img/bg-web.jpg');">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center mx-auto my-auto">
                    ...
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ route('register') }}" class="btn bg-white text-dark" hidden>Create Account</a>
                        @else
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="btn bg-white text-dark">Create Account</a>
                            @endif
                        @endauth
                    @endif
