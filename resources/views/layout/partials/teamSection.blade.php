                ...
                <div class="card card-profile overflow-hidden">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                            <div class="card-body">
                                <h5 class="mb-0">Aditya Rizki Ramadhan</h5>
                                <h6 class="text-info">Back-end Developer</h6>
                                <p class="mb-0">Informatika USK<br>2108107010002</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-12">
                <div class="card card-profile mt-lg-0 mt-5 overflow-hidden">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                            <div class="card-body">
                                <h5 class="mb-0">Putri Ulfayani</h5>
                                <h6 class="text-info">UI/UX Designer</h6>
                                <p>Informatika USK<br>2108107010004</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-12">
                <div class="card card-profile mt-lg-0 mt-5 overflow-hidden z-index-2">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                            <div class="card-body">
                                <h5 class="mb-0">Khairul Auni</h5>
                                <h6 class="text-info">Front-end Developer</h6>
                                <p>Informatika USK<br>2108107010016</p>
                            </div>
                        </div>
                    </div>
                </div>
