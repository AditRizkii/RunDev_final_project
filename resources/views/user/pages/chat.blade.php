                ...
                <div class="card mb-sm-3 mb-md-0 contacts_card ">
                    <div class="card-header">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Search" aria-label="Search" aria-describedby="button-addon2" style="height:43px;">
            ...
            <div class="col-md-8 col-xl-9 chat">
                <div class="card">
                    <div class="card-header msg_head">
                        ...
                        <span id="action_menu_btn" class="mt-2 mx-4"><i class="fas fa-ellipsis-v" style="color: #736ca7;"></i></span>
